...
#...................... Ganesh Ji Drawing USING PYHON TURTLE GRAPHICS ......................

import turtle
import random
wn = turtle.Screen()
wn.setup(width=1100, height=750)
wn.title("COMPUTER SOFT SKILLS :- Ganesh Ji ")
...
style = ('ARIAL BLACK',50,'bold')
t.color('crimson')
t.write('GANESH', font=style, align='right',move=True)
t.hideturtle()
...
t.write('CHATURTHI', font=style, align='right', move=True)
t.hideturtle()
turtle.done()
